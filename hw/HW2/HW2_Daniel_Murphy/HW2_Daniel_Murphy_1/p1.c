...
// double threaded, recursive fibonacci implementation
int fib(int n){
    int x,y;
    if(n<2) return n;
...
// single threaded, recursive fibonacci implementation
int fib_single(int n){
    if(n<2)return n;
    return fib(n-1) + fib(n-2);
}

// runs fibonacci for number fib_count on num_treads threads
